    ...
    <div class="nav_info_dash">
      <aside class="nav_info_dash_emails">
        ...
        <?php
          ...
          $relatorio = "select email, senha, cliente, data from emails;";
      ...
      <aside class="nav_info_dash_sites">   
      <h2>Sites</h2>
      <?php
      mysqli_set_charset($conexao, "utf8");
      $relatorio = "select dominio, cliente, data, valor from sites;";
      ...
      while($dados = $resultado->fetch_assoc()) {
        ...
        echo 'valor: ' ,date('d/m/Y', strtotime($dados["datacad"])), '<br><br>';
        }
      }
      ?>
       </aside>
